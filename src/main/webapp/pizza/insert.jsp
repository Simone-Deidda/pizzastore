				    ...
				    <div class='card-body'>
							...
							<form method="post" action="ExecuteInsertPizzaServlet" class="row g-3" novalidate="novalidate">
								...
								<div class="col-md-6">
									...
									<input type="text" name="nome" id="nome" class="form-control" placeholder="Inserire il nome" value="${insert_pizza_attr.nome }">
								</div>
								...
								<div class="col-md-6">
	                        		...
	                        		<input class="form-control" id="ingredienti" type="text" placeholder="Inserire gli ingredienti" 
	                        				name="ingredienti" value="${insert_pizza_attr.ingredienti}" >
								</div>
								
								<div class="col-md-6">
									<label for="prezzoBase" class="form-label">Prezzo Base</label>
									<input type="number" class="form-control" name="prezzoBase" id="prezzoBase" placeholder="Inserire il prezzo base" value="${insert_pizza_attr.prezzoBase }">
								</div>
