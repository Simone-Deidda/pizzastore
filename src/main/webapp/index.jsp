	   ...
	   <body class="d-flex flex-column h-100">
			...
			<main class="flex-shrink-0">
			  <div class="container">
			     ...
			     <div class="p-5 mb-4 bg-light rounded-3">
				      <div class="container-fluid py-5">
				        <h1 class="display-5 fw-bold">Benvenuto in Pizzastore</h1>
				      </div>
			    </div>
			  ...
			  <c:if test="${userInfo.isAdmin()}">
			  	<div class="jumbotron">
			      <div class="container">
			        <p><a class="btn btn-primary btn-lg" href="ExecuteListClienteServlet" role="button">Gestione Clienti</a></p>
			      </div>
				</div>
			  </c:if>
			  <c:if test="${userInfo.isPizzaiolo()}">
			  	<div class="jumbotron">
			      <div class="container">
			        <p><a class="btn btn-primary btn-lg" href="ExecuteListPizzaServlet" role="button">Gestione Pizze</a></p>
			      </div>
				</div>
				<div class="jumbotron">
			      <div class="container">
				...
				<div class="jumbotron">
			      <div class="container">
			        <p><a class="btn btn-primary btn-lg" href="ExecuteListOrdineServlet" role="button">Gestione Ordini</a></p>
			      </div>
				</div>
			  </c:if>
